...
// IPFS to use after, when building the front
/*
tokenURI() → URL
URL → JSON
...
// Event to add
/* 
Transfer events (mint, burn, transfer)
...
// This interface is an ERC165, which does:
//                                          -> Allows other contracts to detect NFT capability
...
contract RawERC721 {
    ...
    // Check if the "to" contract is able to handle ERC721
